...
public class RollbackWorldConfig extends RollbackConfig implements RollbackMetadata {
    ...
    public RollbackWorldConfig() {
        super(
            new ConfigEntry.Boolean("backupEnabled", null),
            new ConfigEntry.Short("maxBackups", (short)1, MAX_AUTOMATED, null),
            new ConfigEntry.Short("backupFrequency", (short)1, MAX_FREQUENCY, null),
            new ConfigEntry.Enum<>("timerMode", TimerMode.class, null)
        );
    }
